...
function CharacterMenu({ value, onChange, onClick, disabled = false }: Props) {
  ...
  return (
    <div className="flex flex-col gap-11 md:justify-between items-center w-full h-dvh max-h-dvh overflow-y-auto bg-[url('/bg-character-mobile.png')] md:bg-[url('/bg-character-main.png')] bg-cover bg-center bg-no-repeat pt-[70px] md:pt-[50px]  md:pb-15 px-[16px]">
      ...
      <div className="hidden md:flex  md:flex-1 md:w-full md:items-center md:justify-center">
